      ...
      <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link
              to="https://drive.google.com/file/d/1aisnI4lpGdvoU-WogJ9C5Y3TcNwYRCR6/view?usp=drivesdk"  //resume link
          ...
          <div className="mt-8 flex gap-4">
            ...
            <Link
              to="https://github.com/chandan9648"
              target="_blank"
              rel="noreferrer"
              className="p-3 bg-white rounded-lg shadow hover:shadow-md transition"
              aria-label="GitHub"
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M12 0C5.37 0 0 5.37 0 12a12 12 0 008.21 11.44c.6.11.82-.26.82-.58v-2.02c-3.34.73-4.04-1.61-4.04-1.61-.55-1.39-1.34-1.76-1.34-1.76-1.1-.75.08-.74.08-.74 1.22.09 1.86 1.25 1.86 1.25 1.08 1.85 2.83 1.32 3.52 1.01.11-.79.42-1.32.76-1.63-2.67-.3-5.48-1.34-5.48-5.95 0-1.31.47-2.38 1.24-3.22-.13-.3-.54-1.51.12-3.15 0 0 1.01-.32 3.3 1.23a11.5 11.5 0 016 0c2.28-1.55 3.29-1.23 3.29-1.23.67 1.64.26 2.85.13 3.15.77.84 1.23 1.91 1.23 3.22 0 4.62-2.82 5.65-5.5 5.95.43.37.81 1.1.81 2.22v3.29c0 .32.22.7.82.58A12.01 12.01 0 0024 12c0-6.63-5.37-12-12-12z" />
              </svg>
            </Link>
